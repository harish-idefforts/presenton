...
const Schema = z.object({
  message: z
    ...
    .meta({
      description: "Closing thank you message for the audience - should express gratitude and acknowledgment of their participation in the training. DO NOT use meta text like 'Generated slide successfully' or 'Slide created'. Write an actual thank you message. Max 200 characters",
    }),
});
